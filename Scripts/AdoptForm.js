/*First tab shown, step 1 of the form*/
let currentTab = 0;
showTab(currentTab);
...
function showTab(tabIndex) {
  ...
  /*Show button based on form step. Step 1 has no 'PREVIOUS' button, Step 3 has 'SUBMIT' instead of 'NEXT'*/
  if (tabIndex === 0) {
...
function validateForm() {
  ...
  /*For step 2, check if contact number and email input is valid*/
  if (currentTab === 1) {
